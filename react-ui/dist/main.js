...
},{"./views/app":4,"react":162}],2:[function(require,module,exports){
'use strict';
...
},{"../interfaces/service":2,"../router":3,"./employee":9,"./home":10,"react/addons":13}],5:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react/addons');
  ...
  render: function () {
    return (
      React.DOM.header({className: "bar bar-nav"}, 
        React.DOM.a({href: "#", className: "icon icon-left-nav pull-left" + (this.props.back==="true"?"":" hidden")}), 
        React.DOM.h1({className: "title"}, this.props.text)
      )
    );
  }
});
  ...
  render: function () {
    return (
      React.DOM.div({className: "bar bar-standard bar-header-secondary"}, 
        React.DOM.input({type: "search", ref: "searchKey", onChange: this.searchHandler, value: this.props.searchKey})
      )
    );
  }
});

},{"react/addons":13}],7:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react/addons');
  ...
  render: function () {
    return (
      React.DOM.li({className: "table-view-cell media"}, 
        React.DOM.a({href: "#employees/" + this.props.employee.id}, 
          React.DOM.img({className: "media-object small pull-left", src: "pics/" + this.props.employee.firstName + "_" + this.props.employee.lastName + ".jpg"}), 
          this.props.employee.firstName, " ", this.props.employee.lastName, 
          React.DOM.p(null, this.props.employee.title)
        )
      )
    );
  }
...
},{"react/addons":13}],8:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react/addons');
...
},{"./emp-item":7,"react/addons":13}],9:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react/addons');
      ...
      React.DOM.div(null, 
        ReactCSSTransitionGroup({transitionName: "example"}, 
          ...
          React.DOM.div({className: "card"}, 
            React.DOM.ul({className: "table-view"}, 
              React.DOM.li({className: "table-view-cell media"}, 
                React.DOM.img({className: "media-object big pull-left", src: "pics/" + this.state.employee.firstName + "_" + this.state.employee.lastName + ".jpg"}), 
                React.DOM.h1(null, this.state.employee.firstName, " ", this.state.employee.lastName), 
                React.DOM.p(null, this.state.employee.title)
              ), 
              React.DOM.li({className: "table-view-cell media"}, 
                React.DOM.a({href: "tel:" + this.state.employee.officePhone, className: "push-right"}, 
                  React.DOM.span({className: "media-object pull-left icon icon-call"}), 
                  React.DOM.div({className: "media-body"}, 
                  "Call Office", 
                    React.DOM.p(null, this.state.employee.officePhone)
                  )
                )
              ), 
              React.DOM.li({className: "table-view-cell media"}, 
                React.DOM.a({href: "tel:" + this.state.employee.mobilePhone, className: "push-right"}, 
                  React.DOM.span({className: "media-object pull-left icon icon-call"}), 
                  React.DOM.div({className: "media-body"}, 
                  "Call Mobile", 
                    React.DOM.p(null, this.state.employee.mobilePhone)
                  )
                )
              ), 
              React.DOM.li({className: "table-view-cell media"}, 
                React.DOM.a({href: "sms:" + this.state.employee.mobilePhone, className: "push-right"}, 
                  React.DOM.span({className: "media-object pull-left icon icon-sms"}), 
                  React.DOM.div({className: "media-body"}, 
                  "SMS", 
                    React.DOM.p(null, this.state.employee.mobilePhone)
                  )
              ...
              React.DOM.li({className: "table-view-cell media"}, 
                React.DOM.a({href: "mailto:" + this.state.employee.email, className: "push-right"}, 
                  React.DOM.span({className: "media-object pull-left icon icon-email"}), 
                  React.DOM.div({className: "media-body"}, 
                  "Email", 
                    React.DOM.p(null, this.state.employee.email)
                  )
                )
              )
            )
...
},{"../components/header":5,"../components/search-bar":6,"react/addons":13}],10:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react/addons');
var Header = require('../components/header');
var SearchBar = require('../components/search-bar');
...
},{"../components/header":5,"../components/search-bar":6,"../employee/emp-list":8,"react/addons":13}],11:[function(require,module,exports){
...
},{"./invariant":138,"VCmEsw":11}],16:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./DOMProperty":22,"./escapeTextForBrowser":124,"./memoizeStringOnly":146,"./warning":161,"VCmEsw":11}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":34,"./createNodesFromMarkup":118,"./emptyFunction":122,"./getMarkupWrap":131,"./invariant":138,"VCmEsw":11}],25:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":122,"VCmEsw":11}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventPluginRegistry":31,"./EventPluginUtils":32,"./ExecutionEnvironment":34,"./accumulate":111,"./forEachAccumulated":127,"./invariant":138,"./isEventSupported":139,"./monitorCodeUse":151,"VCmEsw":11}],31:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./invariant":138,"VCmEsw":11}],32:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":28,"./invariant":138,"VCmEsw":11}],33:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./EventConstants":28,"./EventPluginHub":30,"./accumulate":111,"./forEachAccumulated":127,"VCmEsw":11}],34:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactPropTypes":82,"./invariant":138,"./warning":161,"VCmEsw":11}],37:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],39:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactMount":73,"./invariant":138,"VCmEsw":11}],41:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSCore":15,"./React":39,"./ReactTransitionEvents":92,"./onlyChild":154,"VCmEsw":11}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./PooledClass":38,"./invariant":138,"./traverseAllChildren":159,"VCmEsw":11}],44:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactCurrentOwner":48,"./ReactOwner":77,"./ReactUpdates":94,"./invariant":138,"./keyMirror":144,"./merge":147,"./monitorCodeUse":151,"VCmEsw":11}],45:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactDOMIDOperations":53,"./ReactMarkupChecksum":72,"./ReactMount":73,"./ReactPerf":78,"./ReactReconcileTransaction":84,"./getReactRootElementInContainer":133,"./invariant":138,"VCmEsw":11}],46:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactComponent":44,"./ReactContext":47,"./ReactCurrentOwner":48,"./ReactErrorUtils":64,"./ReactOwner":77,"./ReactPerf":78,"./ReactPropTransferer":79,"./ReactPropTypeLocationNames":80,"./ReactPropTypeLocations":81,"./ReactUpdates":94,"./instantiateReactComponent":137,"./invariant":138,"./keyMirror":144,"./merge":147,"./mixInto":150,"./monitorCodeUse":151,"./objMap":152,"./shouldUpdateReactComponent":157,"./warning":161,"VCmEsw":11}],47:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":17,"./DOMProperty":22,"./DOMPropertyOperations":23,"./ReactBrowserComponentMixin":40,"./ReactComponent":44,"./ReactEventEmitter":65,"./ReactMount":73,"./ReactMultiChild":75,"./ReactPerf":78,"./escapeTextForBrowser":124,"./invariant":138,"./keyOf":145,"./merge":147,"./mixInto":150,"VCmEsw":11}],52:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":17,"./DOMChildrenOperations":21,"./DOMPropertyOperations":23,"./ReactMount":73,"./ReactPerf":78,"./invariant":138,"VCmEsw":11}],54:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":14,"./DOMPropertyOperations":23,"./LinkedValueUtils":36,"./ReactBrowserComponentMixin":40,"./ReactCompositeComponent":46,"./ReactDOM":49,"./ReactMount":73,"./invariant":138,"./merge":147,"VCmEsw":11}],56:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactBrowserComponentMixin":40,"./ReactCompositeComponent":46,"./ReactDOM":49,"./warning":161,"VCmEsw":11}],57:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./AutoFocusMixin":14,"./LinkedValueUtils":36,"./ReactBrowserComponentMixin":40,"./ReactCompositeComponent":46,"./ReactDOM":49,"./invariant":138,"./merge":147,"VCmEsw":11}],58:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":14,"./DOMPropertyOperations":23,"./LinkedValueUtils":36,"./ReactBrowserComponentMixin":40,"./ReactCompositeComponent":46,"./ReactDOM":49,"./invariant":138,"./merge":147,"./warning":161,"VCmEsw":11}],60:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":28,"./EventListener":29,"./EventPluginHub":30,"./EventPluginRegistry":31,"./ExecutionEnvironment":34,"./ReactEventEmitterMixin":66,"./ViewportMetrics":110,"./invariant":138,"./isEventSupported":139,"./merge":147,"VCmEsw":11}],66:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactRootIndex":85,"./invariant":138,"VCmEsw":11}],71:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./DOMProperty":22,"./ReactEventEmitter":65,"./ReactInstanceHandles":70,"./ReactPerf":78,"./containsNode":114,"./getReactRootElementInContainer":133,"./instantiateReactComponent":137,"./invariant":138,"./shouldUpdateReactComponent":157,"VCmEsw":11}],74:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyObject":123,"./invariant":138,"VCmEsw":11}],78:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"VCmEsw":11}],79:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./emptyFunction":122,"./invariant":138,"./joinClasses":143,"./merge":147,"VCmEsw":11}],80:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"VCmEsw":11}],81:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":44,"./ReactPropTypeLocationNames":80,"./createObjectFrom":119,"./warning":161,"VCmEsw":11}],83:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":44,"./ReactInstanceHandles":70,"./ReactMarkupChecksum":72,"./ReactServerRenderingTransaction":87,"./instantiateReactComponent":137,"./invariant":138,"VCmEsw":11}],87:[function(require,module,exports){
/**
...
},{"./ReactPerf":78,"./invariant":138,"VCmEsw":11}],95:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./LinkedStateMixin":35,"./React":39,"./ReactCSSTransitionGroup":41,"./ReactTestUtils":89,"./ReactTransitionGroup":93,"./cloneWithProps":113,"./cx":120,"./update":160,"VCmEsw":11}],96:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":28,"./EventPluginUtils":32,"./EventPropagators":33,"./SyntheticClipboardEvent":99,"./SyntheticDragEvent":101,"./SyntheticEvent":102,"./SyntheticFocusEvent":103,"./SyntheticKeyboardEvent":104,"./SyntheticMouseEvent":105,"./SyntheticTouchEvent":106,"./SyntheticUIEvent":107,"./SyntheticWheelEvent":108,"./invariant":138,"./keyOf":145,"VCmEsw":11}],99:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],110:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],112:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactPropTransferer":79,"./keyOf":145,"./warning":161,"VCmEsw":11}],114:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"VCmEsw":11}],116:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactCompositeComponent":46,"./invariant":138,"VCmEsw":11}],118:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ExecutionEnvironment":34,"./createArrayFrom":116,"./getMarkupWrap":131,"./invariant":138,"VCmEsw":11}],119:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"VCmEsw":11}],120:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"VCmEsw":11}],124:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"./traverseAllChildren":159,"VCmEsw":11}],126:[function(require,module,exports){
/**
 * Copyright 2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":34,"./invariant":138,"VCmEsw":11}],132:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./warning":161,"VCmEsw":11}],138:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"VCmEsw":11}],139:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],145:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"./keyMirror":144,"VCmEsw":11}],149:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":138,"VCmEsw":11}],152:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":44,"./invariant":138,"VCmEsw":11}],155:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"VCmEsw":11}],158:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014 Facebook, Inc.
 *
...
},{"./invariant":138,"VCmEsw":11}],159:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./ReactInstanceHandles":70,"./ReactTextComponent":90,"./invariant":138,"VCmEsw":11}],160:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
...
},{"./copyProperties":115,"./invariant":138,"./keyOf":145,"VCmEsw":11}],161:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014 Facebook, Inc.
 *
...
},{"./emptyFunction":122,"VCmEsw":11}],162:[function(require,module,exports){
